...
adc welcomes contributions from the community.
...
- Clone your fork of this repo. `git clone git@github.com:YOUR_GIT_USERNAME/adc.git`
- Enter the directory `cd adc`
- Add upstream repo `git remote add upstream https://github.com/muelleth73/adc`
