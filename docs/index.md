...
[![Github CI Status](https://github.com/muelleth73/adc/actions/workflows/main.yml/badge.svg)](https://github.com/muelleth73/adc/actions)
[![GitHub release](https://img.shields.io/github/v/release/muelleth73/adc)](https://github.com/muelleth73/adc/releases)
[![Read the Docs](https://readthedocs.org/projects/adc/badge/?version=stable)](https://adc.readthedocs.io/en/stable/)
[![License](https://img.shields.io/github/license/muelleth73/adc)](https://github.com/muelleth73/adc/blob/main/LICENSE)
[![GitHub issues](https://img.shields.io/github/issues/muelleth73/adc)](https://github.com/muelleth73/adc/issues)
[![PyPI](https://img.shields.io/pypi/v/adc)](https://pypi.org/project/adc/)
[![Downloads](https://pepy.tech/badge/adc)](https://pepy.tech/project/adc/)
...
> **DO NOT FORK** 
> This project is meant to be used from **[Use this template](https://github.com/muelleth73/adc/generate)** feature.

---

1. **Create a new repository using GitHub template**  
   Click on **[Use this template](https://github.com/muelleth73/adc/generate)**.
